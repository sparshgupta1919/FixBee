...
const SignUpPage = () => {
    ...
    const isFormComplete = name.trim() !== '' && email.trim() !== '' && password.trim() !== '';
                ...
                <div className="signin-container">
                    ...
                    <div className="signin-content">
                        ...
                        <h1 className="signin-title">
                            <span className="signin-title-sub">Join your community</span>
                            <span className="signin-title-main">today.</span>
                        </h1>
                        ...
                        <form className="auth-form" onSubmit={handleEmailSignUp}>
                            <div className="auth-card">
                                ...
                                {/* Submit */}
                                <button type="submit" className={`btn-email ${isFormComplete ? 'active' : ''}`}>
                            ...
                            <div className="auth-toggle">
                                ...
                                <button type="button" className="btn-link" onClick={() => navigate('/signin')}>Sign In</button>
                            </div>
                        </form>
